                                ...
                                <form action="edit-user.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" name="gender" id="laki-laki" value="Laki-laki" <?= ($user['jenis_kelamin'] == 'Laki-laki') ? 'checked' : '' ?>>
                                            <label for="laki-laki" class="form-check-label">Laki-laki</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input" name="gender" id="perempuan" value="Perempuan" <?= ($user['jenis_kelamin'] == 'Perempuan') ? 'checked' : '' ?>>
